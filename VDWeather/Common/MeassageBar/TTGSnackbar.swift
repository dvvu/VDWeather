...
open class TTGSnackbar: UIView {
    ...
    @objc open dynamic var topMargin: CGFloat = 24 {
        didSet {
    ...
    @objc open dynamic var actionMaxWidth: CGFloat = 200 {
        didSet {
...
//        actionButton.setImage(#imageLiteral(resourceName: "ic_featured"), for: .normal)
        ...
        let hConstraints = NSLayoutConstraint.constraints(
            withVisualFormat: "H:|-14-[iconImageView]-2-[messageLabel]-2-[seperateView(0.5)]-2-[actionButton(>=44@999)]-0-[secondActionButton(>=44@999)]-14-|",
        ...
        let vConstraintsForMessageLabel = NSLayoutConstraint.constraints(
            withVisualFormat: "V:|-14-[messageLabel]-14-|",
            options: NSLayoutConstraint.FormatOptions(rawValue: 0),
            metrics: nil,
